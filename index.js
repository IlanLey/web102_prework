...
const displayStr = 
    `A total of $${totalPledge.toLocaleString()} has been raised for ${totalCard}. Currently,
    ${totalUnfundedGames}  game${totalUnfundedGames === 1 ? '' : 's'} remain${totalUnfundedGames === 1 ? '' : 's'} unfunded. 
...
console.log(firstGame,secondGame,restOfGames);
